...
SB Gateway 1.6.22 is a bilingual Web-managed traffic-policy gateway packaged as
...
Download `sb-gateway-1.6.22-routeros-bundle.zip` from the GitHub release and
