...
SB Gateway 1.6.20 is a bilingual Web-managed traffic-policy gateway packaged as
...
Download `sb-gateway-1.6.20-routeros-bundle.zip` from the GitHub release and
